...
| `GET` | `/api/v1/onboarding/:id/merchants/ucp/orders/:orderId` | Read a UCP order and its stored payment-token fingerprint |
| `GET` | `/api/v1/onboarding/:id/merchants/ucp/orders/:orderId/payment-options` | Read grouped mandate and saved-card options |
| `DELETE` | `/api/v1/onboarding/:id/merchants/ucp/cart/items/:itemId` | Remove one UCP cart item |
| `DELETE` | `/api/v1/onboarding/:id/merchants/ucp/cart` | Empty the UCP cart |
