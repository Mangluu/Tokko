...
function Dashboard({ state, onState, theme, onTheme, onLogout }) {
  ...
  const title = { home: 'Home', needs: 'Needs you', family: 'Family', activity: 'Activity', more: 'More', addresses: 'Addresses', spending: 'Wallet', settings: 'Settings' }[view];
  const backView = ['addresses', 'settings'].includes(view) ? 'more' : null;
