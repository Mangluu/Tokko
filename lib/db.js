...
async function initialize() {
  ...
  initialization = (async () => {
    ...
    // --- Family-care feature tables (grafted from main; additive to this base) ---
    await db.query(`
...
async function getUcpOrderIntents(userId, limit = 50) {
  const result = await query(
    `SELECT * FROM ucp_order_intents
     WHERE user_id = $1
...
// ---- Family-care feature functions (grafted from main; additive) ----
